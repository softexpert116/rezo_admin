...
const headRows3 = [
    ...
    { id: "tw_option", numeric: false, disablePadding: false, label: "Option" }
];
...
export default function Tweets() {
    ...
    function deleteHandle(key) {
        ...
        selected_tweet_title = selected_tweet[0].description;
        setModalOpen(true);
    }
                                            ...
                                            .map((row, index) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell align="left"><i style={{fontSize:25}} className="flaticon2-trash" style={{ color: "red", cursor: "pointer" }} onClick={() => deleteHandle(row.key)}></i></TableCell>
                                                    </TableRow>
                                                );
                                            })}
                                        {emptyRows3 > 0 && (
                ...
                >
                    <div style={{
                        ...
                        <Typography variant="h3" id="modal-title" style={{ marginBottom: "10px" }} style={{ textAlign: "left", fontSize: "30px", borderRadius:"0px", color:"darkblue" }}>
                            <i className="flaticon2-warning"></i>Warning
                        </Typography>
                        <div style={{height:120, padding:20}}>
                            <p style={{fontSize:20}}>You really want to delete it?</p>
                            <p style={{fontSize:16, color:"red"}}>Description : {selected_tweet_title}</p>
                        </div>
                        <div className="tweets-btn-group" style={{ float: "left", width:"100%", height:"30px", padding:"10px 5px", height:"51px", backgroundColor:"gainsboro" }}>
                            <Button className="btn btn-danger" style={{float:"right", marginLeft:"5px"}} onClick={setModalOpenToClose}>CANCEL</Button>
                            <Button className="btn btn-success" style={{float:"right"}} onClick={deleteTweetItem}>OK</Button>
                        </div>
                    </div>
                </Modal>
                <Modal
